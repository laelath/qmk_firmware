...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----+----+----+----+----+----+----.    ,----|----+----+----+----+----+----|
     LSFT, Z  , X  , C  , V  , B  ,LCTL,     RCTL, N  , M  ,COMM,DOT ,SLSH,RSFT,
  //`----+----+----+--+-+----+----+----/    \----+----+----+----+----+----+----'
  ...
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
     GRV ,MB2 ,MUP ,MB1 ,MWUP,    ,                   ,MINS,EQL ,LBRC,RBRC,QUOT,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
         ,MLFT,MDN ,MRGT,MWDN,    ,               LEFT,DOWN, UP ,RGHT,    ,    ,
  //|----+----+----+----+----+----+----.    ,----|----+----+----+----+----+----|
         ,    ,MB5 ,MB4 ,MB3 ,    ,LALT,     RALT,    ,    ,    ,    ,    ,    ,
  //`----+----+----+--+-+----+----+----/    \----+----+----+----+----+----+----'
                           ,    ,    ,             ,    ,
  //                  `----+----+----'        `----+----+----'
  ),
  ...
  //,----+----+----+----+----+----.              ,----+----+----+----+----+----.
         ,NLCK, P7 , P8 , P9 ,PMNS,                   ,    ,    ,    ,    ,    ,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
     TILD,PENT, P4 , P5 , P6 ,PPLS,                   ,UNDS,PLUS,LCBR,RCBR,DQUO,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
         ,    , P1 , P2 , P3 ,PSLS,               HOME,PGDN,PGUP,END ,INS ,DEL ,
  //|----+----+----+----+----+----+----.    ,----|----+----+----+----+----+----|
         ,    ,    , P0 ,PDOT,PAST,LALT,     RALT,PSCR,SLCK,PAUS,    ,    ,    ,
  //`----+----+----+--+-+----+----+----/    \----+----+----+----+----+----+----'
                           ,    ,    ,             ,    ,
  //                  `----+----+----'        `----+----+----'
  ),
